...
# Find <div class="app-body"> and the closing tag for the main tag before script
...
if body_start != -1 and body_end != -1:
    ...
    body_content = content[body_start + len('<div class="app-body">\n'):body_end]
    ...
    new_body_content += """
      ...
      <div id="view-classrooms" class="dash-view" style="display:none;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
          ...
          <div style="display:flex;gap:10px;" class="teacher-only-action">
            <button class="btn btn-primary" onclick="alert('Module de création de classe ouvert')">
              <i class="fas fa-plus"></i> Créer une classe
            </button>
          </div>
          <div style="display:flex;gap:10px;" class="learner-only-action">
            <button class="btn btn-primary" onclick="alert('Rejoindre une classe')">
